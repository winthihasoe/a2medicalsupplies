...
export default () => {
    ...
    useEffect(() => {
        ...
        // Cleanup the timeout when the component unmounts or when the flash message updates
    ...
    return (
        <div>
            {flash.success && visible && (
                <Snackbar onClose={ButtonClose} message={flash.success} />
            )}
            {flash.message && visible && (
                <div className="mb-8 flex items-center justify-between bg-purple-500 rounded max-w-lg m-auto">
            ...
            {(flash.error || numOfErrors > 0) && visible && (
                <div className="mb-8 flex items-center justify-between bg-red-500 rounded max-w-lg m-auto">
                    <div className="flex items-center">
                        <IconDanger />
                        <div className="py-4 text-white text-sm font-medium">
